...
export const PUBLIC_GAME_URL = "https://desafiohipertensao.iabrasilhub.com.br";
    ...
    <div style={{position:"relative",minHeight:"100vh",animation:"fadeUp .4s ease"}}>
      ...
      <div style={{position:"relative",zIndex:1,padding:"16px 16px 28px",display:"flex",flexDirection:"column",gap:16,minHeight:"100vh"}}>
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"flex-end",alignItems:"center",gap:14,padding:"12vh 8px 24px",textAlign:"center"}}>
          ...
          <div style={{width:"100%",maxWidth:320,display:"grid",gridTemplateColumns:"1fr auto",gap:12,alignItems:"center",background:`${C.teal}16`,border:`1px solid ${C.teal}55`,borderRadius:16,padding:"10px 12px",textAlign:"left",backdropFilter:"blur(10px)"}}>
            <div><div style={{color:C.teal,fontSize:10,fontWeight:900,letterSpacing:1.3}}>JOGO COMPLETO NO CELULAR</div><p style={{color:C.grayLt,fontSize:11,lineHeight:1.45,margin:"4px 0 0"}}>Aponte a câmera para iniciar os 6 módulos no seu dispositivo.</p></div>
            <div style={{background:"#fff",padding:5,borderRadius:8,lineHeight:0}} aria-label="QR Code para abrir o jogo completo"><QRCodeSVG value={PUBLIC_GAME_URL} size={72} bgColor="#ffffff" fgColor="#07090f" level="M" title="Abrir jogo completo"/></div>
          </div>
        </div>
...
function M2Selector({members,onEdit,onFinish,congressMode=false}){
  ...
  return(
    <div style={{padding:"16px",display:"flex",flexDirection:"column",gap:16,animation:"fadeUp .4s ease"}}>
      ...
      {congressMode&&<div style={{background:`${C.teal}10`,border:`1px solid ${C.teal}44`,borderRadius:12,padding:"10px 12px",color:C.grayLt,fontSize:12,lineHeight:1.55}}>🎓 <strong style={{color:C.teal}}>Versão Congresso:</strong> escolha somente um familiar. Ao salvar, você seguirá automaticamente para o Módulo 3 de 6.</div>}
      {configured>0&&(
...
export const LESSON_GUIDES=[
  {module:1,color:C.red,icon:"❤️",title:"Radar de hábitos",time:"3–4 min",objective:"Abrir uma conversa sem transformar hábitos em julgamento.",prepare:"Peça que cada estudante abra o Módulo 1. Combine que ninguém precisará revelar hábitos ou mostrar a própria tela.",say:"Vamos observar situações do cotidiano. Aqui não existe pessoa perfeita: o objetivo é reconhecer escolhas que podem proteger a saúde e pensar em mudanças possíveis.",steps:["Dê 20 segundos para leitura silenciosa antes de cada resposta.","Peça uma votação sem exposição: cada pessoa responde apenas no próprio aparelho.","Convide duas justificativas voluntárias, sem perguntar quem marcou qual alternativa.","Leia o retorno do jogo e transforme a explicação em uma escolha pequena e concreta."],prompt:"Qual escolha pequena poderia proteger a saúde no dia a dia?",listenFor:"Sono, menos energético ou ultraprocessados, movimento, água, pausas e busca de orientação — sem exigir uma resposta única.",intervene:"Se aparecer ‘é só ter força de vontade’, pergunte: ‘O que no ambiente, na rotina ou no acesso pode facilitar ou dificultar essa escolha?’",transition:"Hábitos importam, mas não contam a história toda. Agora vamos olhar como família e rede de apoio também entram no cuidado.",care:"Não peça respostas pessoais em voz alta. Reforce que o radar não calcula risco nem dá diagnóstico."},
  {module:2,color:C.amber,icon:"🧬",title:"Missão família",time:"4–5 min",objective:"Relacionar história familiar, cuidado e rede de apoio de forma respeitosa.",prepare:"Antes de abrir, escolha com a turma uma família fictícia. Se alguém usar dados reais, a participação deve ser voluntária e privada.",say:"Conhecer a história da família pode orientar prevenção, mas não define o futuro de ninguém. Vamos usar uma personagem para aprender sem expor histórias pessoais.",steps:["Apresente a personagem fictícia e deixe claro que campos podem ficar em branco.","Peça que a turma escolha uma pessoa da família da personagem, não da própria família.","Leia as opções e pergunte quais informações ajudariam no cuidado.","Ao final, destaque que histórico familiar aumenta atenção, mas não significa destino ou diagnóstico."],prompt:"Que informação ajudaria um adulto ou profissional a cuidar melhor dessa família?",listenFor:"Histórico de pressão alta, AVC ou infarto, acompanhamento, hábitos e medicamentos conhecidos por um adulto ou profissional.",intervene:"Se alguém começar a contar um diagnóstico familiar, agradeça sem explorar detalhes: ‘Você não precisa compartilhar informações pessoais; vamos voltar à personagem.’",transition:"A história familiar é uma pista. No próximo desafio, vamos descobrir o que pode ser feito, na prática, para proteger a saúde.",care:"Não exponha doenças, idades ou medicamentos reais de familiares. Tudo pode ser deixado em branco."},
  {module:3,color:C.green,icon:"🛡️",title:"Batalha da prevenção",time:"4–5 min",objective:"Transformar recomendações gerais em um plano possível para uma situação concreta.",prepare:"Organize duplas e avise que elas precisarão justificar uma combinação de cartas antes de clicar.",say:"Uma recomendação só funciona quando cabe na vida real. A missão é montar um plano possível para o caso, e não o plano mais perfeito do mundo.",steps:["Leia o caso em voz alta e confirme o que está acontecendo.","Dê 30 segundos para cada dupla escolher uma carta de cada grupo.","Ouça duas combinações e pergunte o que torna cada uma viável.","Registre a decisão no jogo e compare com o feedback, valorizando ajustes possíveis."],prompt:"Qual plano é possível nesta situação e por quê?",listenFor:"Ações específicas, graduais, acessíveis e combinadas com apoio — em vez de proibições absolutas ou soluções mágicas.",intervene:"Se a resposta for radical (‘nunca mais’, ‘cortar tudo’), pergunte: ‘Qual seria o primeiro passo sustentável por uma semana?’",transition:"Prevenir é agir antes do problema. Mas também precisamos reconhecer quando uma situação deixa de ser rotina e vira alerta.",care:"Valorize estratégias acessíveis e evite tratar condição financeira, corpo ou rotina como falha individual."},
  {module:4,color:C.red,icon:"🔍",title:"Caçador de alertas",time:"3–4 min",objective:"Diferenciar sinais que merecem avaliação urgente de sintomas isolados.",prepare:"Combine um sinal de votação silenciosa — dedos, cartões ou enquete — e peça que ninguém simule sintomas.",say:"Pressão alta muitas vezes não dá sintomas. Mesmo assim, alguns sinais fortes indicam que não devemos esperar nem tentar adivinhar o diagnóstico.",steps:["Mostre as opções sem revelar a resposta.","Faça a votação silenciosa e pergunte qual sinal muda a urgência da situação.","Revele o feedback e diferencie ‘suspeitar de hipertensão’ de ‘reconhecer necessidade de ajuda’.","Peça que a turma diga a sequência segura: parar, avisar um adulto e buscar atendimento."],prompt:"Que sinal nos faria parar e procurar um adulto ou atendimento?",listenFor:"Dor no peito, falta de ar, confusão, desmaio, fraqueza de um lado ou fala alterada; também a ideia de que medir é necessário porque pode não haver sintomas.",intervene:"Se alguém sugerir remédio, comida, exercício ou ‘esperar passar’, responda: ‘Sem avaliação, improvisar pode piorar. A prioridade é ajuda adulta e atendimento.’",transition:"Reconhecemos o alerta. Agora vamos acompanhar um caso e perceber por que decidir cedo pode proteger órgãos e reduzir danos.",care:"Reforce: o jogo não diagnostica. Diante de sinais fortes, a conduta é buscar ajuda — não improvisar remédios."},
  {module:5,color:C.orange,icon:"⚠️",title:"Consequências reais",time:"4–5 min",objective:"Praticar decisões seguras em um caso simulado.",prepare:"Avise que o caso é fictício. Forme duplas e combine 20 segundos de conversa antes de cada decisão.",say:"Não estamos tentando assustar. Vamos observar como escolhas feitas no momento certo podem reduzir riscos quando aparecem sinais de alarme.",steps:["Leia apenas a primeira parte do caso e destaque os fatos, sem antecipar a resposta.","Dê 20 segundos para as duplas escolherem a conduta mais segura.","Peça uma justificativa baseada no risco de esperar ou improvisar.","Avance, leia a consequência e repita o processo até concluir o caso."],prompt:"Qual é a decisão mais segura agora? O que pode acontecer se esperarmos?",listenFor:"Interromper a atividade, chamar um adulto, procurar atendimento urgente e acionar o fluxo local; nunca medicar por conta própria.",intervene:"Se a turma dramatizar ou culpar a personagem, redirecione: ‘Vamos avaliar a decisão disponível agora, não julgar como a pessoa chegou até aqui.’",transition:"Em uma urgência, saber agir faz diferença. Para fechar os módulos, vamos praticar como apoiar a família também fora das emergências.",care:"Evite dramatizar ou culpabilizar. Situações de emergência devem seguir o fluxo local e o SAMU 192 onde houver cobertura."},
  {module:6,color:C.teal,icon:"🏥",title:"Como ajudar minha família",time:"3–4 min",objective:"Encerrar com uma ação prática, possível e compartilhada com adultos.",prepare:"Peça que cada dupla pense em uma família fictícia e escolha uma ação que um adolescente possa apoiar com segurança.",say:"Ajudar não é diagnosticar, prescrever ou controlar a vida de alguém. É facilitar informação, apoio e acesso a adultos e profissionais.",steps:["Leia as ações disponíveis e descarte coletivamente as que invadem o papel de profissionais.","Cada dupla escolhe uma ação segura e explica quem mais precisa participar.","Registre a escolha no jogo e leia o feedback.","Peça uma versão ainda mais concreta: quando, onde e com qual adulto essa ação poderia acontecer."],prompt:"Qual ação conseguimos tentar nesta semana sem assumir tarefas de profissionais?",listenFor:"Conversar com respeito, incentivar aferição e acompanhamento, conhecer a UBS, guardar informações úteis com um adulto e apoiar hábitos compartilhados.",intervene:"Se surgir a ideia de mudar ou lembrar doses, diferencie apoio de responsabilidade clínica: ‘Medicamento é decidido com profissional e organizado por adulto responsável.’",transition:"Completamos as seis missões. Agora o quiz vai ajudar a revisar as decisões — e não a dar nota para ninguém.",care:"Adolescentes não devem alterar, organizar ou decidir medicamentos. Apoio e busca de orientação são ações seguras."},
];

function TeacherGuideCard({label,icon,color,children,open=false}){
  return <details open={open} style={{background:C.surface,border:`1px solid ${C.borderHi}`,borderLeft:`3px solid ${color}`,borderRadius:"0 14px 14px 0",overflow:"hidden"}}>
    <summary style={{cursor:"pointer",listStyle:"none",padding:"13px 14px",color,fontSize:11,fontWeight:900,letterSpacing:1.15,display:"flex",alignItems:"center",gap:8}}><span aria-hidden="true">{icon}</span><span style={{flex:1}}>{label}</span><span aria-hidden="true" style={{fontSize:12}}>＋</span></summary>
    <div style={{padding:"0 14px 14px",color:C.grayLt,fontSize:13,lineHeight:1.58}}>{children}</div>
  </details>;
}

function TeacherModuleTutorial({guide,onNext,onExit,isLast}){
  return <div style={{minHeight:"100vh",padding:"22px 16px 32px",display:"flex",flexDirection:"column",justifyContent:"center",gap:16,animation:"fadeUp .4s ease"}}>
    ...
    <div style={{display:"flex",flexDirection:"column",gap:9}}>
      <TeacherGuideCard label="ANTES DE COMEÇAR" icon="🧰" color={guide.color} open><p style={{margin:0}}>{guide.prepare}</p></TeacherGuideCard>
      <TeacherGuideCard label="FALA SUGERIDA" icon="🗣️" color={guide.color} open><p style={{margin:0}}>“{guide.say}”</p></TeacherGuideCard>
      <TeacherGuideCard label="PASSO A PASSO" icon="👣" color={guide.color} open><ol style={{margin:0,paddingLeft:20}}>{guide.steps.map((item,index)=><li key={index} style={{marginBottom:index===guide.steps.length-1?0:7}}>{item}</li>)}</ol></TeacherGuideCard>
      <TeacherGuideCard label="PERGUNTA + RESPOSTAS A OBSERVAR" icon="💬" color={guide.color}><p style={{margin:"0 0 9px",color:C.white,fontWeight:800}}>{guide.prompt}</p><p style={{margin:0}}><strong style={{color:guide.color}}>Escute por:</strong> {guide.listenFor}</p></TeacherGuideCard>
      <TeacherGuideCard label="SE A TURMA TRAVAR OU DESVIAR" icon="↪️" color={guide.color}><p style={{margin:0}}>{guide.intervene}</p></TeacherGuideCard>
      <TeacherGuideCard label="TRANSIÇÃO PARA O PRÓXIMO MÓDULO" icon="🔗" color={guide.color}><p style={{margin:0}}>“{guide.transition}”</p></TeacherGuideCard>
      <TeacherGuideCard label="CUIDADO NA MEDIAÇÃO" icon="🛟" color={guide.color}><p style={{margin:0}}>{guide.care}</p></TeacherGuideCard>
    </div>
    <div style={{background:`${C.teal}10`,border:`1px solid ${C.teal}33`,borderRadius:13,padding:"11px 13px",color:C.grayLt,fontSize:12,lineHeight:1.5}}>🎮 Mantenha este roteiro aberto enquanto a turma joga o <strong style={{color:C.white}}>jogo completo iniciado pelo QR Code do menu principal</strong>.</div>
...
function TeacherMode({onExit}){
  ...
  if(step==="intro")return <div style={{minHeight:"100vh",padding:"22px 16px 32px",display:"flex",flexDirection:"column",justifyContent:"center",gap:16,animation:"fadeUp .4s ease"}}>
    <div style={{background:`linear-gradient(145deg,${C.amber}22,${C.card} 50%,${C.teal}12)`,border:`2px solid ${C.amber}55`,borderRadius:26,padding:"25px 19px",position:"relative",overflow:"hidden"}}><div aria-hidden="true" style={{position:"absolute",right:-24,top:-25,fontSize:128,opacity:.1}}>🧑‍🏫</div><div style={{position:"relative"}}><Tag label="Introdução pedagógica" color={C.amber}/><div style={{fontFamily:"Impact,sans-serif",fontSize:34,letterSpacing:2,color:C.white,lineHeight:.95,marginTop:14}}>MÓDULO PROFESSOR</div><div style={{color:C.amber,fontWeight:900,fontSize:12,letterSpacing:1.2,marginTop:8}}>DIÁLOGO · PROBLEMATIZAÇÃO · AÇÃO–REFLEXÃO</div><p style={{color:C.grayLt,fontSize:14,lineHeight:1.65,margin:"18px 0 0"}}>Antes de iniciar o roteiro, conheça a proposta pedagógica que orienta a experiência. O professor atua como mediador: parte da realidade dos estudantes, provoca perguntas, acolhe saberes prévios e ajuda a transformar decisões do jogo em reflexão e cuidado.</p></div></div>
    <div style={{display:"flex",flexDirection:"column",gap:9}}>
      <TeacherGuideCard label="FUNDAMENTAÇÃO PEDAGÓGICA · LEIA PRIMEIRO" icon="🧠" color={C.amber} open><p style={{margin:"0 0 9px"}}>A experiência combina <strong style={{color:C.white}}>gamificação, situações-problema, discussão entre pares e feedback formativo</strong>. O estudante não recebe o conteúdo apenas como informação pronta: observa uma situação, toma uma decisão, explica seu raciocínio, escuta outras perspectivas e revê sua escolha com a mediação do professor.</p><p style={{margin:"0 0 9px"}}><strong style={{color:C.white}}>Inspiração em Paulo Freire:</strong> a proposta valoriza o diálogo, a problematização da realidade, os conhecimentos que a turma já possui e o movimento de ação–reflexão. O cotidiano dos adolescentes torna-se ponto de partida para construir compreensão e possibilidades de cuidado.</p><p style={{margin:0}}>Essa é uma inspiração pedagógica, não a aplicação integral de um “método Paulo Freire” nem uma alegação de eficácia já comprovada. O jogo continua sendo um recurso educativo que requer mediação, adaptação ao contexto e validação com professores e adolescentes.</p></TeacherGuideCard>
      <TeacherGuideCard label="DISCURSO DE APRESENTAÇÃO DO JOGO" icon="🎤" color={C.purple} open><p style={{margin:0}}>“Este é o <strong style={{color:C.white}}>Desafio Hipertensão</strong>, uma experiência educativa gamificada criada principalmente para adolescentes de <strong style={{color:C.white}}>13 a 17 anos</strong>, faixa que corresponde, em geral, ao <strong style={{color:C.white}}>8º e 9º anos do Ensino Fundamental e ao Ensino Médio</strong>. Durante o jogo, os estudantes passam por seis missões sobre hábitos, história familiar, prevenção, sinais de alerta, consequências da pressão alta e formas seguras de ajudar. Em sala, o professor não entrega todas as respostas: ele apresenta situações, escuta as hipóteses da turma, promove o diálogo e ajuda o grupo a relacionar o conteúdo com a vida cotidiana. Depois da atividade coletiva, quem quiser poderá jogar novamente em casa, compartilhar a experiência com a família e retomar as decisões no próprio ritmo. A proposta combina gamificação, resolução de situações-problema, discussão entre pares e feedback formativo. Sua inspiração freireana está no diálogo, na problematização da realidade e na valorização do conhecimento que o estudante já traz — aprendemos a ler criticamente situações do cotidiano para construir possibilidades de cuidado. O jogo é educativo: não diagnostica hipertensão, não calcula risco clínico e não substitui profissionais de saúde.”</p></TeacherGuideCard>
      <TeacherGuideCard label="PÚBLICO E ADEQUAÇÃO ETÁRIA" icon="👥" color={C.teal} open><p style={{margin:"0 0 9px"}}><strong style={{color:C.white}}>Público principal:</strong> adolescentes de 13 a 17 anos, preferencialmente do 8º e 9º anos do Ensino Fundamental e do 1º ao 3º ano do Ensino Médio.</p><p style={{margin:"0 0 9px"}}><strong style={{color:C.white}}>Uso com 11–12 anos:</strong> possível somente com mediação próxima, leitura compartilhada e adaptação do vocabulário e dos casos.</p><p style={{margin:0}}><strong style={{color:C.white}}>Menores de 11 anos:</strong> esta versão não é a mais indicada; temas familiares, sinais de emergência e decisões clínicas simuladas pedem uma adaptação específica para crianças.</p></TeacherGuideCard>
      <TeacherGuideCard label="COMO USAR: ESCOLA E CASA" icon="🏫" color={C.green} open><p style={{margin:"0 0 9px"}}><strong style={{color:C.white}}>Em sala:</strong> use o jogo como experiência coletiva, com pausas entre os módulos para votação, justificativa, confronto respeitoso de ideias e síntese do professor.</p><p style={{margin:0}}><strong style={{color:C.white}}>Em casa:</strong> depois da aula, o estudante pode repetir o percurso individualmente ou com familiares. Oriente que a conversa seja voluntária, sem expor diagnósticos e sem usar resultados como avaliação de saúde.</p></TeacherGuideCard>
      <div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:16,alignItems:"center",background:`linear-gradient(135deg,${C.teal}16,${C.card})`,border:`1px solid ${C.teal}55`,borderRadius:18,padding:15}}><div><div style={{color:C.teal,fontSize:11,fontWeight:900,letterSpacing:1.4,marginBottom:6}}>QR CODE PARA A TURMA</div><p style={{color:C.grayLt,fontSize:12,lineHeight:1.5,margin:"0 0 7px"}}>Projete este código para abrir o jogo completo no celular.</p><a href={PUBLIC_GAME_URL} target="_blank" rel="noreferrer" style={{color:C.teal,fontSize:11,fontWeight:800,wordBreak:"break-all"}}>{PUBLIC_GAME_URL}</a><a href="/qrcode-desafio-hipertensao.svg" download="qrcode-desafio-hipertensao.svg" style={{display:"block",color:C.white,fontSize:11,fontWeight:900,marginTop:10}}>⬇ BAIXAR QR CODE EM SVG</a></div><div style={{background:"#fff",padding:8,borderRadius:11,lineHeight:0}} aria-label="QR Code do Desafio Hipertensão"><QRCodeSVG value={PUBLIC_GAME_URL} size={116} bgColor="#ffffff" fgColor="#07090f" level="M" title="Abrir Desafio Hipertensão"/></div></div>
      <TeacherGuideCard label="PREPARE A AULA" icon="🧰" color={C.amber} open><ul style={{margin:0,paddingLeft:19}}><li style={{marginBottom:7}}>Reserve de 25 a 35 minutos e projete o jogo ou peça um aparelho por dupla.</li><li style={{marginBottom:7}}>Abra o jogo completo para a turma pelo QR Code do menu principal.</li><li style={{marginBottom:7}}>Mantenha este roteiro em outro aparelho ou aba para consultar entre os módulos.</li><li>Combine participação voluntária, respostas privadas e uso de personagens fictícias.</li></ul></TeacherGuideCard>
      <TeacherGuideCard label="ABERTURA · FALE PARA A TURMA" icon="🗣️" color={C.amber} open><p style={{margin:0}}>“Hoje vamos tomar decisões em um jogo sobre pressão arterial. A proposta não é descobrir quem é saudável, dar diagnóstico ou comparar resultados. Vamos analisar situações, conversar sobre escolhas possíveis e aprender quando pedir ajuda. Ninguém precisa contar informações pessoais ou da família.”</p></TeacherGuideCard>
      <TeacherGuideCard label="COMBINE COMO A TURMA VAI JOGAR" icon="🤝" color={C.teal}><ol style={{margin:0,paddingLeft:20}}><li style={{marginBottom:7}}>Uma pessoa lê; a dupla conversa antes de tocar na resposta.</li><li style={{marginBottom:7}}>Discordar é permitido, mas toda escolha precisa de uma justificativa respeitosa.</li><li style={{marginBottom:7}}>Dados pessoais podem ficar em branco e não serão usados como nota.</li><li>Ao terminar cada módulo, a turma espera sua orientação para continuar.</li></ol></TeacherGuideCard>
      <TeacherGuideCard label="MAPA DO TEMPO" icon="⏱️" color={C.green}><p style={{margin:0}}>Abertura 3 min · Módulos 1 a 6 entre 3 e 5 min cada · Quiz e fechamento 5 min. Se houver menos tempo, ouça uma justificativa por etapa e mantenha os cuidados de segurança.</p></TeacherGuideCard>
    </div>
  ...
  if(step==="closing")return <div style={{minHeight:"100vh",padding:"22px 16px 32px",display:"flex",flexDirection:"column",justifyContent:"center",gap:16,animation:"fadeUp .4s ease"}}><div style={{textAlign:"center",background:`linear-gradient(145deg,${C.purple}20,${C.card})`,border:`2px solid ${C.purple}55`,borderRadius:26,padding:"26px 18px"}}><div style={{fontSize:56}}>🎯</div><Tag label="Fechamento da aula · 5 min" color={C.purple}/><div style={{fontFamily:"Impact,sans-serif",fontSize:30,letterSpacing:2,color:C.white,marginTop:12}}>QUIZ FINAL E CONVERSA</div><p style={{color:C.grayLt,fontSize:14,lineHeight:1.6,margin:"13px 0 0"}}>Use o quiz para revisar raciocínios, não para classificar estudantes. Depois, transforme o percurso em uma síntese e uma ação possível.</p></div><div style={{display:"flex",flexDirection:"column",gap:9}}><TeacherGuideCard label="1 · CONDUZA O QUIZ" icon="🎮" color={C.purple} open><ol style={{margin:0,paddingLeft:20}}><li style={{marginBottom:7}}>Leia cada questão e dê 20 segundos para decisão individual ou em dupla.</li><li style={{marginBottom:7}}>Peça uma justificativa antes de revelar a resposta.</li><li style={{marginBottom:7}}>Após o feedback, pergunte por que as outras alternativas seriam menos seguras.</li><li>Normalize erros como oportunidade de revisão; não peça placares em voz alta.</li></ol></TeacherGuideCard><TeacherGuideCard label="2 · RETOME O QUE FOI APRENDIDO" icon="💬" color={C.purple} open><p style={{margin:"0 0 8px"}}>Escolha duas perguntas:</p><ul style={{margin:0,paddingLeft:19}}><li style={{marginBottom:7}}>O que foi mais fácil ou mais difícil de decidir?</li><li style={{marginBottom:7}}>Que orientação você levaria para uma conversa em casa?</li><li style={{marginBottom:7}}>Quando é importante buscar ajuda de um adulto ou profissional?</li><li>Que ideia do jogo mudou ou ficou mais clara para você?</li></ul></TeacherGuideCard><TeacherGuideCard label="3 · CONSTRUA UMA SÍNTESE" icon="🧠" color={C.teal}><p style={{margin:0}}>Registre três ideias da turma e complete se necessário: pressão alta pode não dar sintomas; prevenção combina hábitos, contexto e acompanhamento; sinais de alarme pedem ajuda, nunca automedicação.</p></TeacherGuideCard><TeacherGuideCard label="4 · FALA FINAL SUGERIDA" icon="🗣️" color={C.green} open><p style={{margin:0}}>“Cuidar da pressão não é buscar perfeição nem assumir o papel de um profissional. É fazer escolhas possíveis, conversar com adultos de confiança, medir corretamente quando orientado e procurar ajuda diante de sinais de alarme. O jogo é educativo: não diagnostica e não substitui avaliação profissional.”</p></TeacherGuideCard><TeacherGuideCard label="5 · DEPOIS DA AULA" icon="📌" color={C.amber}><p style={{margin:0}}>Não recolha placares como nota. Se surgir uma preocupação pessoal, converse em particular, acolha sem diagnosticar e encaminhe para o adulto responsável e para o fluxo de saúde da escola ou do município.</p></TeacherGuideCard></div><Btn onClick={()=>setStep("intro")} color={C.amber} outline style={{width:"100%"}}>↻ REINICIAR ROTEIRO DO PROFESSOR</Btn><Btn onClick={onExit} color={C.gray} outline style={{width:"100%"}}>← VOLTAR À CAPA</Btn><CreditsFooter/></div>;
  const guide=LESSON_GUIDES[step];
  return <TeacherModuleTutorial guide={guide} onNext={()=>setStep(step===LESSON_GUIDES.length-1?"closing":step+1)} onExit={onExit} isLast={step===LESSON_GUIDES.length-1}/>;
}
...
function CongressReport({nickname,m1Answers,m1Questions,family,preventionChallenge,preventionResult,alertResult,m5Result,m6Result,finalQuiz,finalQuizAnswers,onReset,onExit,lessonMode=false}){
  ...
  return <div data-report style={{padding:"16px",display:"flex",flexDirection:"column",gap:18,animation:"fadeUp .4s ease"}}>
    ...
    <div className="no-print" style={{display:"flex",flexDirection:"column",gap:10}}><div style={{background:`${C.yellow}10`,border:`1px solid ${C.yellow}44`,borderRadius:12,padding:"10px 12px",color:C.grayLt,fontSize:12,lineHeight:1.55}}>🔒 Este relatório pode conter apelido, idade aproximada e antecedentes de um familiar. Salve ou compartilhe somente com autorização.</div>{!lessonMode&&<div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:14,alignItems:"center",background:`linear-gradient(135deg,${C.teal}16,${C.card})`,border:`1px solid ${C.teal}55`,borderRadius:18,padding:15}}><div><div style={{color:C.teal,fontSize:11,fontWeight:900,letterSpacing:1.5,marginBottom:5}}>CONTINUE NO JOGO COMPLETO</div><p style={{color:C.grayLt,fontSize:12,lineHeight:1.5,margin:0}}>Aponte a câmera para experimentar os seis módulos na versão integral.</p></div><div style={{background:"#fff",padding:7,borderRadius:10,lineHeight:0}} aria-label="QR Code para abrir o jogo completo"><QRCodeSVG value={PUBLIC_GAME_URL} size={104} bgColor="#ffffff" fgColor="#07090f" level="M" title="Abrir jogo completo"/></div></div>}<Btn onClick={()=>window.print()} color={C.teal} size="lg" style={{width:"100%"}}>🖨️ IMPRIMIR OU SALVAR RELATÓRIO</Btn><Btn onClick={onReset} color={C.green} size="lg" style={{width:"100%"}}>↻ PRÓXIMO VISITANTE</Btn><Btn onClick={onExit} color={C.gray} outline style={{width:"100%"}}>CONHECER O JOGO COMPLETO</Btn><CreditsFooter/></div>
  </div>;
}
...
function CongressMode({onExit,lessonMode=false}){
  ...
  const goToModule=module=>setStage(lessonMode?`lesson-m${module}`:module===2?"m2sel":`m${module}`);
  ...
  if(stage==="m2sel")return <CongressModuleFrame module={2} title="MISSÃO FAMÍLIA" summary="Mapeie 1 familiar" color={C.amber}><M2Selector members={members} onEdit={id=>{setActiveMemberId(id);setStage("m2detail");}} onFinish={()=>goToModule(3)} congressMode/></CongressModuleFrame>;
  ...
  return <div style={{minHeight:"100vh",padding:"22px 16px",display:"flex",alignItems:"center",justifyContent:"center"}}><div style={{width:"100%",maxWidth:380,textAlign:"center",background:C.card,border:`1px solid ${C.borderHi}`,borderRadius:20,padding:24}}><div style={{fontSize:40}}>↻</div><div style={{fontFamily:"Impact,sans-serif",fontSize:24,letterSpacing:1.5,color:C.white,marginTop:10}}>RETOMAR PRÉVIA</div><p style={{color:C.grayLt,fontSize:13,lineHeight:1.55}}>A próxima etapa não foi encontrada. Reinicie a prévia para percorrer os seis módulos.</p><Btn onClick={reset} color={C.teal} size="lg" style={{width:"100%"}}>REINICIAR PRÉVIA</Btn></div></div>;
}
